...
What makes me different from other frontend developers is that I don't just implement designs — I interrogate them. I'll flag accessibility issues, question interaction patterns that don't serve users, and fill in the gaps the brief left out. I've been told this is both my greatest strength and occasionally annoying. I'm fine with that.`,
    ...
    timeline: [
      ...
      },
      {
        ...
        tech: ['Vue.js', 'Nuxt', 'SCSS', 'Headless CMS'],
      },
      {
        date: '2017 – 2019',
        role: 'Frontend Developer',
    ...
    caseStudies: [
      {
        ...
        description: 'A multi-step registration flow was spec\'d as a single long page. I proposed breaking it into progressive steps with smart defaults and inline validation, reducing the form from 3 minutes to under 90 seconds. Completion rate went up. I didn\'t just build a form — I thought about who was filling it in and why they might give up.',
      },
      {
  ...
  },
  {
    ...
    intro: `Before I became a "frontend developer" I spent years deep in the trenches of digital marketing production — building eDM templates and campaigns in Salesforce Marketing Cloud (ExactTarget), creating dynamic HTML banners for Google DV360 and DoubleClick, and managing campaign deployments for some of Australia's biggest brands.
...
This background gives me something most frontend developers don't have: a deep understanding of how marketing teams work, what they need from technology, and how to bridge the gap between creative intent and technical delivery.`,
    ...
    timeline: [
      {
        ...
        tech: ['Salesforce Marketing Cloud', 'HTML Email'],
      },
      {
        date: '2016 – 2019',
        role: 'eDM & Banner Developer',
        company: 'Various Agencies (Clemenger, Isobar, Trout)',
        description: 'Managed end-to-end eDM development for clients including Myer and Australia Post. Built and maintained template systems, created dynamic HTML banners for programmatic campaigns, handled deployment and QA across major email clients.',
        tech: ['ExactTarget', 'DV360', 'HTML', 'CSS'],
      },
      {
        date: '2012 – 2016',
        ...
        tech: ['Flash', 'HTML', 'CSS', 'JavaScript'],
      },
    ],
    caseStudies: [
      {
  ...
  },
  {
    ...
    intro: `I'm not a UX designer by title, but I think like one. Every ticket I pick up, I'm asking: who's using this? What are they trying to do? What happens when it goes wrong? What did we forget?
...
Some people find this annoying. Most come to appreciate it.`,
  ...
  },
  {
    ...
    variant: 'vibes',
    intro: `This is the part of my CV that doesn't fit on a normal CV, but it's honestly some of the work I'm most proud of.
