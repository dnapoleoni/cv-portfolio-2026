    ...
    caseStudies: [
      {
        ...
        description:
          "A multi-step registration flow was spec'd as a single long page. I proposed breaking it into progressive steps with smart defaults and inline validation, reducing completion time from 3 minutes to under 90 seconds. I didn't just build a form — I thought about who was filling it in and why they might give up.",
      },
      {
        title: 'Accessible by default, not as an afterthought.',
        description:
          'On a component library build, I established accessibility as a baseline rather than a checkbox. Every component shipped with proper ARIA attributes, keyboard navigation, and screen reader announcements. When the client later needed to meet WCAG AA compliance, we were already there.',
      },
    ],
  },
  {
    ...
    caseStudies: [
      {
        ...
        description:
          "Built a modular template system that let the marketing team assemble campaign emails from pre-built, tested components. This cut production time per campaign from days to hours while maintaining consistency across Myer's brand guidelines and ensuring rendering across 30+ email clients.",
      },
    ],
  },
  {
    ...
    timeline: [
      {
        ...
        description:
          "This isn't a separate chapter of my career — it's how I approach every role. Whether I was building banner ads or React components, I've always asked \"but does this actually work for the person using it?\"",
      },
    ],
    caseStudies: [
      {
        ...
        description:
          'On a dashboard build, the designs covered the happy path beautifully but had zero treatment for empty states, error states, loading states, or the "you have 400 items and the page is now unusable" state. I documented every gap, proposed solutions for each, and built them. The PM later said it saved them a sprint\'s worth of bug reports.',
      },
      {
        title: 'Questioning the brief, improving the outcome.',
        description:
          'A feature spec called for a simple dropdown with 200+ options. I pushed back and proposed a searchable combobox with recent selections and smart grouping. The extra day of work saved users from scrolling through an alphabetical list every single time they used the feature.',
      },
    ],
  },
  {
    ...
    timeline: [
      {
        ...
        description:
          "At every agency and company I've been part of, I've created or contributed to social programs, culture initiatives, and interactive experiences that made the workplace genuinely more enjoyable.",
      },
    ],
    caseStudies: [
      {
        ...
        description:
          "This section is a work in progress — I'm gathering specific examples, photos, and stories from the social clubs, ARGs, events, and culture initiatives I've run across my career. Watch this space.",
      },
    ],
  },
];
